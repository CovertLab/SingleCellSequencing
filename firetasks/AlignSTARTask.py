...
@explicit_serialize
class AlignSTARTask(FireTaskBase):

	_fw_name = "AlignSTARTask"
	...
	def run_task(self, fw_spec):
		...
		for seq_file in file_list:
			...
			seq_functions.run_STAR(self["library_path"], seq_file_name, trimmed_name = self["trimmed_name"], aligned_name = self["aligned_name"])
