...
def main(sequencing_directory, library_prefix, num_libraries, raw_data_dir):
	...
	subdirs = ['unzipped', 'trimmed', 'aligned', 'alignedSTAR', 'bammed', 'sorted', 'counted', 'pythonized']
	...
	for library_dir in library_dirs:
		...
		fw_count = Firework(
			[
				AlignSTARTask(library_path = library_dir, trimmed_name = "trimmed", aligned_name = "alignedSTAR/")
			],
			name = name,
