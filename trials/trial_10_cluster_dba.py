...
dynamics_load = np.load('/home/dvanva/SingleCellSequencing/' + str(time_point[0])+'_dynamics_distance_matrix.npz')
if time_point[0] == 75:
...
for j in xrange(len(cluster_id_list)):
	...
	plt.tight_layout()
file_name = "DBA_all_clusters_"+str(time_point[0])+"min_all.pdf"
