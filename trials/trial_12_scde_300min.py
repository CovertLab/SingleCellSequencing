...
r("facts_1v2 = facts")
r("""facts_1v2[ facts == 0 | facts == 3] = NA""")
r("facts_1v2 = factor(facts_1v2)")
r("print(facts_1v2)")

r("facts_1v3 = facts")
r("""facts_1v3[ facts == 0 | facts == 2] = NA""")
r("facts_1v3 = factor(facts_1v3)")
r("print(facts_1v3)")
...
r("ediff_1v2 = scde.expression.difference(o.ifm, counts_data_int, o.prior, groups  =  facts_1v2, n.randomizations  =  100, n.cores  =  1, verbose  =  1)")
r("""write.table(ediff_1v2[order(abs(ediff_1v2$Z), decreasing = TRUE), ], file = "/scratch/PI/mcovert/dvanva/sequencing/300min_scde_results_1v2.txt", row.names = TRUE, col.names = TRUE, sep = "\t", quote = FALSE)""")

r("ediff_1v3 = scde.expression.difference(o.ifm, counts_data_int, o.prior, groups  =  facts_1v3, n.randomizations  =  100, n.cores  =  1, verbose  =  1)")
r("""write.table(ediff_1v3[order(abs(ediff_1v3$Z), decreasing = TRUE), ], file = "/scratch/PI/mcovert/dvanva/sequencing/300min_scde_results_1v3.txt", row.names = TRUE, col.names = TRUE, sep = "\t", quote = FALSE)""")
