...
r("facts_2v1 = facts")
r("""facts_2v1[ facts == 0 | facts == 3] = NA""")
r("facts_2v1 = factor(facts_2v1)")
r("print(facts_2v1)")

r("facts_2v3 = facts")
r("""facts_2v3[ facts == 0 | facts == 1] = NA""")
r("facts_2v3 = factor(facts_2v3)")
r("print(facts_2v3)")
...
r("ediff_2v1 = scde.expression.difference(o.ifm, counts_data_int, o.prior, groups  =  facts_2v1, n.randomizations  =  100, n.cores  =  1, verbose  =  1)")
r("""write.table(ediff_2v1[order(abs(ediff_2v1$Z), decreasing = TRUE), ], file = "/scratch/PI/mcovert/dvanva/sequencing/300min_scde_results_2v1.txt", row.names = TRUE, col.names = TRUE, sep = "\t", quote = FALSE)""")

r("ediff_2v3 = scde.expression.difference(o.ifm, counts_data_int, o.prior, groups  =  facts_2v3, n.randomizations  =  100, n.cores  =  1, verbose  =  1)")
r("""write.table(ediff_2v3[order(abs(ediff_2v3$Z), decreasing = TRUE), ], file = "/scratch/PI/mcovert/dvanva/sequencing/300min_scde_results_2v3.txt", row.names = TRUE, col.names = TRUE, sep = "\t", quote = FALSE)""")
