...
for cell in all_cells:
	if cell.time_point == 0:
		cell.clusterID = str(0)
	if cell.time_point == 75:
		cell.clusterID = str(1)
	if cell.time_point == 150:
		cell.clusterID = str(2)
	if cell.time_point == 300:
		cell.clusterID = str(3)
...
r("""save(counts_data_int, file = "/scratch/PI/mcovert/dvanva/sequencing/counts_data.RData")""")
...
r("""facts_75 = facts""")
r("""facts_75[ facts == 2 | facts == 3] = NA""")
r("facts_75 = factor(facts_75)")
r("print(facts_75)")

r("""facts_150 = facts""")
r("""facts_150[ facts == 1 | facts == 3] = NA""")
r("facts_150 = factor(facts_150)")
r("print(facts_150)")

r("""facts_300 = facts""")
r("""facts_300[ facts == 1 | facts == 2] = NA""")
r("facts_300 = factor(facts_300)")
r("print(facts_300)")
