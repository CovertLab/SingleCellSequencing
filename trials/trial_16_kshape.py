...
for t in times:
	...
	np.savez('/home/dvanva/SingleCellSequencing/'+str(t)+"_dynamics_distance_matrix_kshape.npz", distance_matrix = distance_matrix)
	dynamics_load = np.load('/home/dvanva/SingleCellSequencing/'+str(t)+"_dynamics_distance_matrix_kshape.npz")
	...
	plt.savefig("plots/trial_16_dynamics_clustering_" + str(t) + "min.pdf")
