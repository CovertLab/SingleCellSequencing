...
metabolic_genes = ["Hmox1", "Prdx1", "Hdc", "Ptgs2", "Irg1"]
...
for time_point in times_to_analyze:
	...
	plt.clf()
	fig, axes = plt.subplots(len(metabolic_genes),1, figsize = (10,20))
	counter = 0
	...
	plt.savefig("plots/" + str(time_point) + "min/metabolic/" + file_name)
