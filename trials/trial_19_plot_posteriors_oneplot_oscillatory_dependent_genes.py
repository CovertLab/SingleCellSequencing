...
osc_genes = ['Dnmt3b', 'Tecta', 'Tm6sf2', 'Bricd5', 'Prdm12', 'Prdm13', 'Adora2a', 'Ccdc162', 'Gm5283', 'Gm11400', 'Olfr536', 'Gm13145', 'Gm13333', 'Zfp661', 'Angptl3', 'Sipa1l3', 'Scn1a', 'Sprr2d', 'Il17rc', 'Zglp1', 'Akr1cl', 'Map1a', 'Trim14', 'Adgrg6', 'Gm13991', 'Dhrs11', 'Gm21834', 'Iqca', 'Gm2007', 'Slc39a8', 'Gng7', 'AL663030.1', 'Nphp4', 'Nod1', 'Emc9', 'Akr1b7', 'Il33', 'Mmp14', 'Zfyve1', 'Cetn4', '2610305D13Rik', 'Mettl25', 'Ric8b', 'Mterf2', 'Zfp850', 'Clec4a4', 'Saa3', 'Hist1h4n', 'Gm11007', 'Cntrob', 'Atp7b', 'Mtl5', '1700061G19Rik', 'Coro2b', '1700030J22Rik', 'Gm8898', 'Tmem86b', 'Car9', 'Gm5157', 'Gm15539', 'Arhgef18', 'Slc13a3', 'Dclk1', 'Ager', 'Actr3b', 'Zfp41', 'Fzd8', '4930524J08Rik', 'Zic5', 'Trem1', 'Ppp1r32', 'Stk36', 'Gnao1', 'Tmem239', 'Polm', 'Fgf21', 'Gprasp2', 'Tesk1', 'Athl1', 'Kptn']
...
for time_point in times_to_analyze:
	...
	"""
	plt.clf()
	fig, axes = plt.subplots(len(osc_genes)/4 ,4, figsize = (60,60))
	counter = 0

	for gene in osc_genes:
		gene_name = """'""" + gene + """'"""
	...
	plt.savefig("plots/" + str(time_point) + "min/osc/" + file_name)
