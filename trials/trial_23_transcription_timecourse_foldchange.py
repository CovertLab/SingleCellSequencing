...
# list_of_genes = ["Nfkbia", "Tnfaip3", "Nfkbie", "Nfkbiz", "Nlrp3", "Tnfaip2"]
...
for gene in list_of_genes:
	...
	axes.flatten()[counter].set_ylim([1,np.ceil(1.05*max_val)])
	axes.flatten()[counter].set_yticks([1,np.ceil(1.05*max_val)])
