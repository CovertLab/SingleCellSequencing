...
list_of_genes = sorted(list_of_genes)
print list_of_genes

file_name = "trial_23_every_gene_v3.pdf"
...
fig, axes = plt.subplots(len(list_of_genes)/10+1,10, figsize = (4*10,4*(len(list_of_genes)/10 + 1)))
...
for gene in list_of_genes:
	...
	axes.flatten()[counter].spines['right'].set_visible(False)
	axes.flatten()[counter].spines['top'].set_visible(False)
